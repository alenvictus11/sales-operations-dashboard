...
- [sql/05_product_analysis.sql](SQL/05_product_analysis.sql) - Product Category Performance
...
- [sql/08_payment_method_analysis.sql](SQL/08_payment_method_analysis.sql) - Payment method performance
